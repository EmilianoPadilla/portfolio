        ...
        <div className="max-w-2xl mx-auto flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a
              ...
              className="bg-[#111827] border border-gray-800 rounded-xl p-6 flex flex-col items-center gap-3 hover:border-blue-500/50 transition-colors duration-300 text-center"
            >
